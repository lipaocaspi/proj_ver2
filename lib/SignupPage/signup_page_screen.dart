...
class SignUpPageState extends State<SignUpPage> {
  ...
  validate () async {
    final response = await http.get(Uri.parse("http://192.168.1.2:3000/users?email=$email"));
  ...
  postUser() async {
    final res = await http.get(Uri.parse("http://192.168.1.2:3000/users"));
    if(res.statusCode == 200) {
      ...
      final response = await http.post(Uri.parse("http://192.168.1.2:3000/users"),

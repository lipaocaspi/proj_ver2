...
class NewRideMapE extends StatefulWidget {
  NewRideMapE({Key? key, required this.value, required this.users}) : super(key: key);
  Position value;
  final Users users;

  @override
  State<NewRideMapE> createState() => NewRideMapEState();
}

class NewRideMapEState extends State<NewRideMapE> {

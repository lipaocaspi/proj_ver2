...
class EditRideMapS extends StatefulWidget {
  EditRideMapS({Key? key, required this.value, required this.ride}) : super(key: key);
  Position value;
  final Ride ride;

  @override
  State<EditRideMapS> createState() => _EditRideMapSState();
}

class _EditRideMapSState extends State<EditRideMapS> {

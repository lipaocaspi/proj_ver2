...
class MessagePage extends StatefulWidget {
  MessagePage({Key? key, required this.rideId, required this.idU, required this.id, required this.users, required this.message, required this.message_count}) : super(key: key);
  int rideId;
  int idU;
  int id;
  final Users users;
...
class MessagePageState extends State<MessagePage> {
  ...
  sendMessage() async {
    if(_controllerMessage.text.isEmpty) {
      ...
      final res = await http.post(Uri.parse("http://192.168.1.41:3000/messages"),
